...
function showmyPg() {
    ...
    $("#historyPage").html("<div class=\'card\'><div class=\"card-body\">你还没有快递哦！<br>你可以点击 <button type=\"button\" class=\"btn btn-sm bg-primary fa fa-search srch-btn\" style=\"color: white\"> 添加快递</button> 以搜索或添加你的快递。</div></divc>");
        ...
        for (x in Pgidlist) {
            ...
            $.get(getUrl, function (data, status) {
                ...
                var Content = "<br><div class=\"card\"><div class=\"card-header\"><div class='fa fa-archive'> ID-</div>" +
                    ...
                    Pdata[6] + "\">" +
                    Pdata[7] + "</a></div></div><div class=\"card-footer\">" +
                    Pdata[5] + "<div class=\"btn-group-sm fR\"><button type=\"button\" class=\"btn btn-sm btn-primary fa fa-pencil\" data-toggle=\"modal\" data-target=\"#myModal\"></button><button type=\"button\" class=\"btn btn-sm btn-danger fa fa-trash-o\"></button></div></div></div></div>";
                $("#historyPage").append(Content);
                updat()
            });
        }
    }
